    ...
    public function run()
    {
        ...
        $examples = [
            ...
            ['order' => 6,
             ...
             'description' => 'https://www.youtube.com/watch?v=a7ntf6wiIik',
             'type' => 'video-external',
            ],
        ];
